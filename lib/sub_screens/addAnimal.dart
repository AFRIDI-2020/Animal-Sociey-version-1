...
import 'package:pet_lover/custom_classes/progressDialogWidget.dart';
import 'package:pet_lover/custom_classes/progress_dialog.dart';
import 'package:pet_lover/custom_classes/videoCompressApi.dart';
...
class _AddAnimalState extends State<AddAnimal> {
  ...
  Future _compressVideo(File file) async {
    ...
    print('compressed video info : ${info!.toJson()}');
    setState(() {
